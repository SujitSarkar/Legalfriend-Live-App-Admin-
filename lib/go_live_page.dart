                                    ...
                                    child: Stack(
                                      ...
                                      children: [
                                        SizedBox(width: size.width * .8,
                                            child: Text('PREVIOUS',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(color: PColor.yellowColor,fontSize: size.width*.08))),
                                        Positioned(
                                            left: 5.0,
                                            child: Icon(CupertinoIcons.arrowtriangle_left,color: Colors.white,size: size.width*.1,))
                                      ],
                                    ),
                                    onPressed: () async{
                                      if(doc['serial_number']!=0){
                                        if(doc['is_live']){
                                          await FirebaseFirestore.instance.collection('LiveSerial').doc('123456').update({
                                            'serial_number': doc['serial_number']-1,
                                ...
                                SolidButton(
                                    child: Stack(
                                      ...
                                      children: [
                                        ...
                                        Positioned(
                                            right: 5.0,
                                            child: Icon(CupertinoIcons.arrowtriangle_right,color: Colors.white,size: size.width*.1,))
                                      ],
                                    ),
                                    onPressed: () async{
                                      if(doc['is_live']){
      ...
      children: [
        Expanded(
          child: ListWheelScrollView(
            ...
            onSelectedItemChanged: (index)=> setState(()=>_selectedSerial=index),
            children: _serialNumberList.map((e) => Container(
              alignment: Alignment.center,
